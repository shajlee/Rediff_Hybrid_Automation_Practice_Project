package com.qa.hybridpractice.listeners;
...
import com.qa.hybridpractice.utilities.Hybrid_Practice_ExtentReporter;

public class MyHybridPracticeListeners implements ITestListener {
	...
	public void onStart(ITestContext context) {
		try {
			extentReport = Hybrid_Practice_ExtentReporter.generateExtentReport();
		} catch (Exception e) {
